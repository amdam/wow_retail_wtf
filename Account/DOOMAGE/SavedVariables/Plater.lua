...
PlaterDB = {
	["captured_spells"] = {
		...
		[51219] = {
			["event"] = "SPELL_CAST_SUCCESS",
			["source"] = "Velarok the Annihilator",
			["npcID"] = 46859,
		},
		[384327] = {
			["event"] = "SPELL_AURA_APPLIED",
